...
DO $$ BEGIN
  ALTER TABLE "AdSlotInventory" ADD CONSTRAINT "AdSlotInventory_issueId_fkey"
    FOREIGN KEY ("issueId") REFERENCES "Issue"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DROP INDEX IF EXISTS "AdSlotInventory_venueId_restroomId_qrCodeId_slotNumber_month_key";
CREATE UNIQUE INDEX IF NOT EXISTS "AdSlotInventory_issueId_venueId_restroomId_qrCodeId_slotNumber_month_key"
  ON "AdSlotInventory"("issueId", "venueId", "restroomId", "qrCodeId", "slotNumber", "month");
