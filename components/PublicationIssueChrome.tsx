export function PublicationHeader({ monthYear, venueLine }: { monthYear: string; venueLine?: string }) {
  return (
    <header className="masthead">
      <img className="masthead-banner" src="assets/potty-favor-original-banner-2.png" alt="Potty Favor publication masthead" width={2171} height={724} />
...
export function PublicationFooter() {
  return (
    <footer className="publication-footer">
      © {new Date().getFullYear()} Potty Favor / Stall Talk. Same monthly issue. Smarter venue ads.
    </footer>
  );
}
