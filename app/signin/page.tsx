  ...
  return (
    <main className="min-h-screen bg-paper p-6 text-ink">
      <section className="mx-auto max-w-xl rounded-2xl border-4 border-ink bg-white p-6 shadow-brutal">
        ...
        {!auth.isConfigured ? <p className="mt-4 rounded-xl border-2 border-ink bg-stallYellow p-3 font-black">Setup required: set DATABASE_URL and AUTH_SECRET to enable secure admin, advertiser, and venue sessions.</p> : null}
        ...
        <p className="mt-4 text-sm font-bold">Seed users: admin@pottyfavor.com, advertiser@pottyfavor.com, and venue@pottyfavor.com. Admin publish tokens remain server-side or in local browser settings only.</p>
      </section>
    </main>
  );
}
