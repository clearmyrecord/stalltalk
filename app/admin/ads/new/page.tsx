...
export default async function NewAdPage() {
  ...
  return (
    <AdStudioAgency
      ...
      savedCampaigns={savedCampaigns.map((campaign) => ({ campaignId: campaign.campaignId, businessName: campaign.business, headline: campaign.headline || "", subheadline: campaign.subheadline || "", ctaText: campaign.ctaText || "Claim Offer", couponCode: campaign.couponCode || "", adSize: "4:3 Sponsor Card", imageUrl: campaign.image || "", promptUsed: campaign.prompt, createdAt: campaign.createdAt.toISOString(), slotPublished: campaign.slotPublished, selectedSlot: campaign.selectedSlot, targetUrl: campaign.targetUrl, logoBase64: campaign.logoBase64, publishStatus: campaign.publishStatus, publishedAt: campaign.publishedAt?.toISOString() || null, targetType: campaign.targetType, targetLabel: campaign.targetLabel, parentCampaignId: campaign.parentCampaignId, versionNumber: campaign.versionNumber }))}
    />
  );
}
