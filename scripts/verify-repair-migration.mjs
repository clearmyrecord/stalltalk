...
INSERT INTO "qr_codes" ("id", "venueId", "restroomId", "qr_name", "qr_slug", "slug", "qr_url") VALUES ('qr_1', 'venue_1', 'restroom_1', 'QR One', 'qr-one', 'qr-one', '/q/qr-one') ON CONFLICT DO NOTHING;
...
const checks = [
  ...
  ["IssueTarget backfill without duplicates", "SELECT COUNT(*) = COUNT(DISTINCT \"id\") AND COUNT(*) = 3 FROM \"IssueTarget\""]
];
