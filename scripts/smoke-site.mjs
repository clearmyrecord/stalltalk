...
assert((index.match(/data-ad-slot="[1-8]"/g) || []).length >= 16, "Public page must include desktop and mobile instances of all eight ad slots.");
...
assert(styles.includes("position: sticky") && styles.includes("mobile-ad-strip") && styles.includes("print-grid"), "Styles must support sticky ads, mobile ad strips, and magazine layout.");
